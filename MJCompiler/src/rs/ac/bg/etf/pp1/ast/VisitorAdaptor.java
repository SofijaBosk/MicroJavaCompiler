...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(Relop_LES Relop_LES) { visit(); }
    ...
    public void visit(NewFactor_ActPars NewFactor_ActPars) { visit(); }
    public void visit(NewFactor_Expr NewFactor_Expr) { visit(); }
    ...
    public void visit(CondTerm_Item CondTerm_Item) { visit(); }
    public void visit(CondTerm_Chain CondTerm_Chain) { visit(); }
    ...
    public void visit(ElseDummy ElseDummy) { visit(); }
    public void visit(IfDummy IfDummy) { visit(); }
    ...
    public void visit(FormParsDummy FormParsDummy) { visit(); }
    public void visit(MethodParams MethodParams) { visit(); }
