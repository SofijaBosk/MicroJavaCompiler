...
public class DesignatorStatementList_List extends DesignatorStatementList {

    private DesignatorStatementList DesignatorStatementList;
    private DesignatorStatement DesignatorStatement;

    public DesignatorStatementList_List (DesignatorStatementList DesignatorStatementList, DesignatorStatement DesignatorStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementList_List(\n");
