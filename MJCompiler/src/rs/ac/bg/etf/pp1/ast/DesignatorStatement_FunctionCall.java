...
public class DesignatorStatement_FunctionCall extends DesignatorStatement {

    private FunctionCall FunctionCall;

    public DesignatorStatement_FunctionCall (FunctionCall FunctionCall) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatement_FunctionCall(\n");
